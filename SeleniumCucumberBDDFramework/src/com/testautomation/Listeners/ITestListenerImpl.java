...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener
{
	...
	public void onTestSuccess(ITestResult result) {
		/*
		 * PropertiesFileReader obj= new PropertiesFileReader(); TestNGContentHandler
		 * testdata=new TestDataHandler(); Map<String,String>
		 * testData=testdata.getTestDataInMap();
		 * 
		 * Properties properties; try { properties = obj.getProperty();
		 * ExcelHandler.UpdateTestResultsToExcel(
		 * properties.getProperty("testdatafilepath"),
